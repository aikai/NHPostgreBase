...
{
    public partial class LimGenTest : ListPage
    {
        protected override void Search()
        {
            try
            {
                var dao = DaoFactory.GetLimGenDao();
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                {
                    var entity = EntityFactory.CreateLimGen();

                    entity.GenDep = ((TextBox)GridView1.Rows[0].Cells[2].Controls[0]).Text;
                    entity.Suffix = ((TextBox)GridView1.Rows[0].Cells[3].Controls[0]).Text;
                    ...
                    #region Create by
                    entity.CreateBy = SessionAdapter.User == null
                        ? string.Empty : SessionAdapter.User.UserId;
                ...
                else
                {
                    ...
                    if (entity != null)
                    {
                        entity.GenDep = ((TextBox)GridView1.Rows[e.RowIndex].Cells[2].Controls[0]).Text;
                        entity.Suffix = ((TextBox)GridView1.Rows[e.RowIndex].Cells[3].Controls[0]).Text;
                        ...
                        #region Update by
                        entity.UpdateBy = SessionAdapter.User == null
                            ? string.Empty : SessionAdapter.User.UserId;
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dt.Insert(0, EntityFactory.CreateLimGen());
